...
export default function ListCenter(props) {
  ...
  return (
    ...
    { arrBusinessByCareersType?.businesses?.filter(item =>item.status ==="active").length !==0  ?
      <Fragment>
      {arrBusinessByCareersType?.businesses?.filter(item =>item.status ==="active").map((item, index) => {
      return (
        <div className="w-100 h-auto shadow rounded-3 bg-white p-2 mb-3">
          <div className="w-100 h-auto p-0 m-0 pt-2">
            ...
            <div className="listings_center">
              ...
              <div className="p-1 ps-0 star_898989 star_mb" style={{display:'flex'}}>
                <small>
            ...
            <div className="pe-2 listings_right">
              ...
              <div className="w-100 by_trangvang">
                BY YELLOW PAGES
              </div>
            </div>
          ...
          <div className="w-100 h-auto p-0 m-0 mt-4">
            ...
            <div className="email_web_section">
              ...
              >
                <i className="fa-regular fa-envelope pe-1" /> Gửi
                Email
              </a>
              <a
                rel="nofollow"
     ...
     : <div style={{textAlign:'center', fontWeight:600, fontSize:'20px', paddingTop:'20px'}}>Không tìm thấy doanh nghiệp phù hợp</div>}
