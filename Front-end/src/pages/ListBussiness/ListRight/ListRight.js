    ...
    <div className="div_banner_qc_pc">
              <div className="w-100 h-auto">
                <a
                  target="_blank"
                  rel="nofollow"
                  href="http://vietanphat.com.vn/"
                >
                  <img
                    className="w-100 rounded-1"
                    title="CÔNG TY TNHH SXTM & DV VIệT AN PHÁT"
                    alt="Công Ty TNHH SXTM & DV Việt An Phát"
                    src="https://banner.trangvangvietnam.com/ctyvietanphat-maydonggoi.gif"
                  />
                </a>
              </div>
              <p
              ...
              <div className="w-100 h-auto">
                <a target="_blank" rel="nofollow" href="http://mychau.com.vn/">
                  <img
                    className="w-100 rounded-1"
                    title="CÔNG TY CP IN VÀ BAO BÌ Mỹ CHÂU - BAO BÌ THựC PHẩM"
                    alt="Công Ty CP In Và Bao Bì Mỹ Châu - Bao bì thực phẩm"
                    src="https://banner.trangvangvietnam.com/ctymychau-thucpham.gif"
                  />
                </a>
              </div>
              <p
              ...
              <div className="w-100 rounded-3 bg-white p-3 mb-3  pt-4 border-bottom color666">
                ...
                <div className="h-auto w-100">
                  <p className="m-0 pt-4 pb-2 text-center lh-lg">
                    Đăng ký doanh nghiệp lên Trang vàng là cách đơn giản, hiệu
                    quả nhất để:
                    <br />
