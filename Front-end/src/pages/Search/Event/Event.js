...
export default function Event() {
  return (
    <div className="h-auto bg-white rounded-4 mt-3 addtop_pc">
                ...
                <div className="p-3 trangvang_add_cell">
                  ...
                  >
                    <NavLink to="/signup">
                      <img
                        style={{ width: "96%" }}
                        src="https://trangvangvietnam.com/images/signup_icon.png"
                      />
                   </NavLink>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <p className="m-0 pt-2 text-black-50 trangvang_add_fontsize">
                      <small>
                        Quảng bá DN đến 250.000 tìm kiếm mỗi ngày,..
                      </small>
                    </p>
                  </div>
                </div>
                <div className="p-3 trangvang_add_cell_1">
                  ...
                  >
                     <NavLink to="/advertising">
                      <img
                        style={{ width: "100%" }}
                        src="https://trangvangvietnam.com/images/yellowpages_add.png"
                      />
                  </NavLink>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <p className="m-0 pt-2 text-black-50 trangvang_add_fontsize">
                      <small>
                        Đứng đầu, nổi bật, tiếp cận người mua trước,..
                      </small>
                    </p>
                  </div>
                </div>
                <div className="p-3 trangvang_add_cell_2">
                  ...
                  >
                   <NavLink to="/stores">
                      <img
                        style={{ width: "96%" }}
                        src="https://trangvangvietnam.com/images/web_design.png"
                      />
                   </NavLink>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <p className="m-0 pt-2 text-black-50 trangvang_add_fontsize">
                      <small>
                        Chuyên nghiệp, chuẩn SEO, miễn phí Hosting,...
                      </small>
                    </p>
                  </div>
                </div>
